function effects(timer)
	...
	doeffect(timer,nil,"dance","pet",1,0,30,{0,3})
	doeffect(timer,nil,"worst","hot",1,2,5,{1,1})
	doeffect(timer,nil,"bleeding","hot",1,2,2,{2,1})
	...
	doeffect(timer,nil,"mlelt","unlock",1,1,8,{4,rnd},"inwards")
...
function shorteffectblock()
	...
	doshorteffect(nil,"splash","confetti",6,{-10,10},{-25,-10},{{1,2},{1,3},{0,3},{0,2}})
